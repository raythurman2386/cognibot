...
export default function Header() {
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-black mx-auto">
              ...
              <div className="grid grid-cols-3 gap-8">
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-zinc-200 dark:text-zinc-100">
                    OpenAI integration allows you to communicate with ChatGPT 4 Turbo, and generate images with DALL E 3.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-black bg-opacity-50 rounded-full">
                  ...
                  <h2 className="text-xl font-bold text-white">Anthropic</h2>
                  <p className="text-zinc-200 dark:text-zinc-100">
                    Anthropic Integration allows you communicate with Claude 2.1.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 bg-black bg-opacity-50 rounded-full">
                  ...
                  <p className="text-zinc-200 dark:text-zinc-100">
                    With Advanced Customization, you can personalize your bot client to suit your preferences and work
                    style.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
